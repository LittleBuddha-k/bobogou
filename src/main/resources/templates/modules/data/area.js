layui.use(['form', 'table'], function () {
    ...
    table.on('toolbar(areaTableFilter)', function (obj) {
        if (obj.event === 'add') {  // 监听添加操作
            var index = rc.openSaveDialog("/bobogou/data/area/form/add", "新建区级信息")
            ...
            if (idArr[1]) {
                ...
                ids = idArr[0];
                rc.openSaveDialog('/bobogou/data/area/form/edit?id=' + ids, "编辑区级信息");
            }
            $(window).on("resize", function () {
                layer.full(index);
            });
            ...
            if (idArr[1]) {
                ...
                ids = idArr[0];
                rc.openViewDialog('/bobogou/data/area/form/view?id=' + ids, "查看区级信息");
            }
            $(window).on("resize", function () {
                layer.full(index);
            });
