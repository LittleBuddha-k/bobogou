layui.use(['form', 'table'], function () {
    ...
    table.on('toolbar(commodityTagTableFilter)', function (obj) {
        if (obj.event === 'add') {  // 监听添加操作
            var index = rc.openSaveDialog("/bobogou/data/commodityTag/form/add", "新建轮播图信息")
            ...
            if (idArr[1]) {
                ...
                ids = idArr[0];
                rc.openSaveDialog('/bobogou/data/commodityTag/form/edit?id=' + ids, "编辑轮播图信息");
            }
            $(window).on("resize", function () {
                layer.full(index);
            });
            ...
            if (idArr[1]) {
                ...
                ids = idArr[0];
                rc.openViewDialog('/bobogou/data/commodityTag/form/view?id=' + ids, "查看轮播图信息");
            }
            $(window).on("resize", function () {
                layer.full(index);
            });
