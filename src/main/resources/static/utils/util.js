(function ($) {
    ...
    rc = {
        ...
        openOrderViewDialog: function open(url, title, width, height) {
            layui.use('layer', function () {
                var layer = layui.layer;
                layer.open({
                    type: 2,
        ...
        openMenuSelectDialog: function open(url, title, width, height) {
            layui.use('layer', function () {
                var layer = layui.layer;
                layer.open({
                    type: 2,
        ...
        openAreaSelect: function open(url, title, width, height, id) {
            layui.use(['layer', 'form'], function () {
                var layer = layui.layer;
                var form = layui.form;
